...
`empirical_summary.json` contains the machine-readable headline metrics and the bounded release finding for **Empirical Engineering Design Trade Space: Concrete Slump Experiments**.
