...
- `pca_clustering`
- `student_grade_regression`
- `lstm_time_series`

## Why this empirical bundle is distinct
This is a systems-engineering trade-study artifact built from laboratory engineering alternatives and Pareto dominance. It is not a generic predictive benchmark or unsupervised visualization exercise.
